...
function navigate(pageName) {
    ...
    if (pageName === 'catalog') {
        ...
        loadCatalog();
        // Загружаем рекомендации и расписание с небольшой задержкой
...
// ============================================
// 1. КАТАЛОГ (НОВИНКИ — БЫСТРАЯ ЗАГРУЗКА)
// ============================================
async function loadCatalog() {
    ...
    grid.innerHTML = '<div style="text-align:center;padding:40px;color:#888;"><div class="spinner-small"></div><br>⏳ Загрузка новинок...</div>';
...
// ============================================
// ... (комментарии, избранное, достижения, профиль, топ, аватар, toast, модальные окна)
